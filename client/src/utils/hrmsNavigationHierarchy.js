...
export function getSectionTabs(pathPrefix, icons = {}) {
  ...
  return [
    ...
    },
    {
      ...
      tabs: [
        { label: 'Dashboard', to: buildPath(pathPrefix, 'payroll/dashboard'), icon: icon('dashboard'), permission: 'payroll.stats' },
        { label: 'Configuration', to: buildPath(pathPrefix, 'payroll/salary-components'), icon: icon('settings'), permission: 'payroll.salary' },
        { label: 'Min Wage', to: buildPath(pathPrefix, 'payroll/minimum-wage'), icon: icon('settings'), permission: 'payroll.salary' },
        { label: 'Rules', to: buildPath(pathPrefix, 'payroll/rules'), icon: icon('settings'), permission: 'payroll.process' },
        { label: 'Template Engine', to: buildPath(pathPrefix, 'payroll/compensation'), icon: icon('payroll'), permission: 'payroll.compensation' },
        { label: 'Breakup Engine', to: buildPath(pathPrefix, 'payroll/salary-assignment-excel'), icon: icon('employees'), permission: 'payroll.compensation' },
        { label: 'Process', to: buildPath(pathPrefix, 'payroll/process'), icon: icon('settings'), permission: 'payroll.process' },
        { label: 'History', to: buildPath(pathPrefix, 'payroll/run'), icon: icon('calendar'), permission: 'payroll.run' },
        { label: 'Payslips', to: buildPath(pathPrefix, 'payroll/payslips'), icon: icon('file'), permission: 'payroll.payslips' },
        { label: 'Reports', to: buildPath(pathPrefix, 'payroll/reports'), icon: icon('history'), permission: 'payroll.stats' },
